...
<div class="container body-content" style="width: 600px;">
	...
	<form action="deleteAvailableProductDb.jsp" method="post">
		<div class="form-horizontal">
			<div class="row"
				style="border: 1px solid #bbb9b9; border-radius: 5px; padding-top: 25px;">
				<div class="col-sm-12">
					<c:forEach var="row" items="${result.rows}"  readonly="readonly">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input class="form-control text-box single-line" id="Maker"
									name="Maker" type="text" value="${row.maker}"  readonly="readonly" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input class="form-control text-box single-line" id="dateAdded"
									name="dateAdded" type="text" type="date" value="${row.adddate}" readonly="readonly"/>
							</div>
						</div>
				</div>
			</div>
