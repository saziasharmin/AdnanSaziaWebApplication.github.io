...
<form action="insertRegisteredProductDb.jsp" method="post">
  <div class="form-horizontal">
        <div class="row" style="border:1px solid #bbb9b9;border-radius:5px;padding-top:25px;">
            <div class="col-sm-12">
                    ...
                    <div class="col-md-9">
                        <input class="form-control text-box single-line" id="userName" name="userName" type="text" /> 
                    </div>
                </div>    
...
<c:forEach var = "col" items = "${result.rows}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input class="form-control text-box single-line" id="maker" name="maker" type="text"  />
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="control-label col-md-3" for="purchaseDate">Purchase Date</label>
                    <div class="col-md-9">
                        <input class="form-control text-box single-line" id="purchaseDate" name="purchaseDate" type="text"  />
                    </div>
                </div>
