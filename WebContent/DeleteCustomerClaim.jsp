...
<div class="container body-content" style="width: 600px;">
	...
	<form action="deleteCustomerClaimDb.jsp" method="get">
			...
			<div class="row"
				...
				<div class="col-sm-12">
					<c:forEach var="row" items="${result.rows}">
						<div class="form-group">
							...
							<div class="col-md-9">
								<input class="form-control text-box single-line" id="claimid"
									name="claimid" type="text" value="${row.claimid}" readonly="readonly"/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input class="form-control text-box single-line" id="serialno"
									name="serialno" type="text" value="${row.serialno}" readonly="readonly"/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input class="form-control text-box single-line" id="claimdate"
									name="claimdate" type="text" value="${row.claimdate}" readonly="readonly"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input class="form-control text-box single-line" id="status"
									name="status" type="text" value="${row.status}" readonly="readonly"/>
							</div>
						</div>
						<div class="form-group">
                       ...
                       <c:out value="${row.damagedescription}" readonly/>
                        </textarea>
							</div>
						</div>
				</div>
