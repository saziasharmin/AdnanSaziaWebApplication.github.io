...
<!-- Testing and Database operation  -->
</head>
<body>
	<c:if
		test="${empty param.claimid && empty param.userName 
			&&  empty param.serialno && empty param.productName
			&& empty param.claimDate && empty param.damagedescription}">
		<c:redirect url="DeleteAdminClaim.jsp">
	...
	<sql:setDataSource var="dbsource" driver="com.mysql.jdbc.Driver"
		...
		password="123456" />
	<c:if
		test="${not empty param.claimid && not empty param.userName 
