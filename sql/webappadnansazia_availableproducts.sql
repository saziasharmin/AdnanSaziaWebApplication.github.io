...
LOCK TABLES `availableproducts` WRITE;
/*!40000 ALTER TABLE `availableproducts` DISABLE KEYS */;
INSERT INTO `availableproducts` VALUES ('1','tttt','hp','today'),('2','Washing Machine','dd','today'),('4','Washing Machine','hp','today'),('80000','TV','hp','today');
/*!40000 ALTER TABLE `availableproducts` ENABLE KEYS */;
UNLOCK TABLES;
